...
<body>
    <div class="container py-5">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card stat-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="display-6 fw-bold"><?php echo e($countPelanggan); ?></div>
                        <a href="<?php echo e(route('read')); ?>" class="btn btn-sm btn-primary mt-3">Lihat Detail</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card stat-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="display-6 fw-bold text-danger"><?php echo e($countProduk); ?></div>
                        <a href="<?php echo e(route('read.produk')); ?>" class="btn btn-sm btn-danger mt-3">Lihat Detail</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card stat-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="display-6 fw-bold text-info"><?php echo e($countTransaksi); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="card stat-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="display-6 fw-bold text-success">Rp <?php echo e(number_format($totalPenjualan, 0, ',', '.')); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(route('form_penjualan')); ?>" class="btn btn-light me-2">+ Input Penjualan</a>
            <a href="<?php echo e(route('lihat_penjualan')); ?>" class="btn btn-outline-light">🛒💯 Data Penjualan</a>
        </div>
    </div>

    <script src="/bootstrap-5.3.8/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\laragon\www\pengelolaan-basisdata\resources\views/index.blade.php ENDPATH**/ ?>