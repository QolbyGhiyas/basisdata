            ...
            <div class="col-12 col-lg-10">
                <div class="card shadow-lg">
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('update_penjualan', $penjualan->id)); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="PelangganID" name="PelangganID" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = $pelanggan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->id); ?>" <?php echo e($penjualan->PelangganID == $p->id ? 'selected' : ''); ?>><?php echo e($p->NamaPelanggan); ?></option>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" id="TanggalPenjualan" name="TanggalPenjualan" class="form-control" value="<?php echo e($penjualan->TanggalPenjualan); ?>" required>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle" id="produkTable">
                                            ...
                                            <tbody id="produkBody">
                                                <?php $__empty_1 = true; $__currentLoopData = $detail_penjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr class="produk-row">
                                                        <td>
                                                            <select name="ProdukID[]" class="form-select form-select-sm produk-select" required>
                                                                <option value="">-- Pilih Produk --</option>
                                                                <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($p->id); ?>" data-harga="<?php echo e($p->HargaProduk); ?>" <?php echo e($detail->ProdukID == $p->id ? 'selected' : ''); ?>><?php echo e($p->NamaProduk); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm harga-input" value="<?php echo e($detail->produk->HargaProduk ?? 0); ?>" readonly>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="JumlahProduk[]" class="form-control form-control-sm jumlah-input" min="1" value="<?php echo e($detail->JumlahProduk); ?>" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm subtotal-input" value="<?php echo e($detail->SubTotal); ?>" readonly>
                                                            <input type="hidden" name="SubTotal[]" class="subtotal-hidden" value="<?php echo e($detail->SubTotal); ?>">
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="mt-3 text-end">
                                        <div class="fw-bold" style="font-size: 1.1em; color: #667eea;">
                                            Total Harga: Rp <span id="totalHargaDisplay"><?php echo e(number_format($penjualan->TotalHarga, 0, ',', '.')); ?></span>
                                        </div>
                                        <input type="hidden" id="TotalHarga" name="TotalHarga" value="<?php echo e($penjualan->TotalHarga); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('lihat_penjualan')); ?>" class="btn btn-secondary flex-grow-1">Lihat Daftar</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\pengelolaan-basisdata\resources\views/form_edit_penjualan.blade.php ENDPATH**/ ?>