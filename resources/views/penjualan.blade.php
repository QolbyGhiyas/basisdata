            ...
            <div class="col-12 col-md-10">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('insert.penjualan') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="TanggalPenjualan" name="TanggalPenjualan" class="form-control" value="{{ date('Y-m-d') }}" required>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('lihat_penjualan') }}" class="btn btn-secondary">Lihat Daftar</a>
                                <a href="{{ url('/') }}" class="btn btn-outline-primary">Kembali ke Dashboard</a>
                            </div>
                        </form>
